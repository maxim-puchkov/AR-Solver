...
<pre>MainMenuViewController – connects user and the application
    functionality</pre>
 
 1. The view will display UIButtons, such as:
 ...
 2. When the input is determined, user will have access
    ...
    * __CANONICAL FORM__:   The expression will be simplified and
